<template>
  <div id="welcome">
    ...
    <!-- 跳转覆盖层 -->
    <div v-show="!showSnow && isPowerOn" id="video-overlay" @click="jumpToMainApp">
    ...
    <!-- 电源按钮（控制雪花屏显示/隐藏） -->
    <img id="power-button" :class="{ rotated: isPowerButtonRotated }" src="@/assets/button.png" alt="Power Button"
      @click="togglePower" />

    <!-- 视频播放控制按钮 -->
    <img id="play-button" :class="{ rotated: isPlayButtonRotated, disabled: showSnow }" src="@/assets/button.png"
      alt="Play Button" @click="togglePlay" />
